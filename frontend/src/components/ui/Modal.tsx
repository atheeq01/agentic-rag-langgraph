      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="fixed inset-0 bg-foreground/10 dark:bg-background/80 backdrop-blur-sm"
            onClick={onClose}
            aria-hidden="true"
          />
          ...
          <motion.div
            ...
            className={`relative w-full ${maxWidthMap[maxWidth]} bg-card border border-border shadow-2xl rounded-2xl overflow-hidden flex flex-col max-h-[90vh] z-10`}
            role="dialog"
            aria-modal="true"
