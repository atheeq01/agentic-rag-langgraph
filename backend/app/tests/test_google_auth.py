...
def test_google_login_url(client, db):
    client.post("/auth/register", json={"email": "google@test.com", "password": "123", "full_name": "Test"})
    token = client.post("/auth/login", json={"email": "google@test.com", "password": "123"}).json()["access_token"]
